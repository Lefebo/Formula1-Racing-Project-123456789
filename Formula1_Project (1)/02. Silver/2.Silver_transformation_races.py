...
# MAGIC 3. Standardize and rename  column names using snake case (circuitId→ circuit_id, raceName-> race_name)
...
# MAGIC 6. Transform column values of race_name  to Title case
...
races_df = races_df.select('season',
 'round',
 'raceName',
 'date',
 'circuitId',
...
races_df.filter((races_df['season'].isNull()) | (races_df['round'].isNull())).display()
...
duplicate = races_df.groupBy(races_df.columns)\
  .count()\
...
display(races_df[(races_df.season=='1950') & (races_df.round=='4')])
